            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2">
                            <form class="form-horizontal" method="post" action="/action/process_login">
                                <?php if (session()->getFlashdata('success_register')) : ?>
                                    <div class="alert alert-success" role="alert">
                                        <?= session()->getFlashdata('success_register'); ?>
                                    </div>
                                <?php elseif (session()->getFlashdata('login_msg')) : ?>
                                ...
                                <div class="mt-4 text-center">
                                    ...
                                    <br><br> -->
                                    <p>Tidak punya akun ? <a href="<?= base_url(); ?>/auth/register" class="fw-medium text-primary"> Daftar sekarang</a> </p>
